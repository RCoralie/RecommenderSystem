...
def requests(idMovies):
    """
        ...
        return:
            ...
            errors -> index list of movie IDs not found on TMDB
    """ 
    ...
    return infos, keywords, credits, errors
...
def getTmdbGenres():
    ...
    if not isfile(Config.GENRES_FILE):
        saveTmdbGenres()

    return np.load(Config.GENRES_FILE)[0]
